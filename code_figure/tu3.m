...
figure;
box on;
plot(I(1,1:450),deltaKrate(1,1:450),'-','LineWidth',4,'Color',[0 0 0.6]);
xlabel('optical power /W','FontWeight','bold','FontName','Times New Roman','FontSize',35);
ylabel('\DeltaK/K ','FontWeight','bold','FontName','Times New Roman','FontSize',35);
set(gca,'FontSize',35,'FontWeight','bold');
set(gca,'linewidth',4);
set(gca,'Fontname','times new Roman');
%%
% plot(I,Pr_I_dark,'-','LineWidth',3,'Color',[0.70 0.55 0.4]);
% plot(I,Pr_I_ruo,'-','LineWidth',3,'Color',[0.2 0.6 0.1]);
% plot(I,Pr_I_qiang1,'-','LineWidth',3,'Color',[0.02 0.7 0.7]);
% plot(I,Pr_I_qiang2,'-','LineWidth',3,'Color',[0.8 0.02 0.8]);

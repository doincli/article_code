...
delta_v=linspace(1,840,15)*10^3;  
...
% yyaxis left;
% hold on ; 
% plot(signal_power,Pr_I_dark);
% plot(signal_power,Pr_I_ruo);
% plot(signal_power,Pr_I_qiang1);
% plot(signal_power,Pr_I_qiang2);
% 
% yyaxis right;
% hold on ;
% plot(signal_power,log(phase_noise1(10,:)));
% plot(signal_power,log(phase_noise1(30,:)));
% plot(signal_power,log(phase_noise1(60,:)));
% plot(signal_power,log(phase_noise1(100,:)));
% for i =1:15
% plot(signal_power,log(phase_noise1(i,:)));
% end
%%
%画图
figure;
...
xlabel('Linewidth \Delta\upsilon / kHz','Rotation',25,'Position',[10.5 3 0],...
'FontName','Times New Roman');
ylabel('\sigma_I^2 ','Rotation',-30,'Position',[1.5 -0.5 0],'FontName','Times New Roman');
zlabel('phase noise power (log)','Rotation',-90,'Position',[-1.5 0 -10]);
set(gca,'FontSize',30);
set(gca,'linewidth',3);
set(gca,'xticklabel',{'1','60','120','180','240','300','360','420','480','540','600','660','720','780','840'});
...
hold on;
box on;
plot(delta_v1,log10(BPSK_BER_dark),'-bd','MarkerIndices',1:10:length(delta_v1),'LineWidth',4);
plot(delta_v1,log10(BPSK_BER_ruo),'-g>','MarkerIndices',1:10:length(delta_v1),'LineWidth',4);
plot(delta_v1,log10(BPSK_BER_qiang1),'-rp','MarkerIndices',1:10:length(delta_v1),'LineWidth',4);
plot(delta_v1,log10(BPSK_BER_qiang2),'-m+','MarkerIndices',1:10:length(delta_v1),'LineWidth',4);
% title("强湍流和弱湍流,夜视情况下的PDF(log)");
set(gca,'linewidth',3)
